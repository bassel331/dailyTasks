...
//
//    @Test
//    @Sql(statements = "INSERT INTO courses(id, name, description, credit) VALUES (4L, 'john', 'oo', 1)", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
//    @Sql(statements = "DELETE FROM courses WHERE id='4L'", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
...
//        assertEquals(courseList.size(), courseService.getAllCourses().size());
//        assertEquals(courseList.size(), courseRepository.findAll().size());
//    }
//}
